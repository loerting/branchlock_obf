    ...
    <div class="card-header rounded-top-4 d-flex align-items-center justify-content-between">
        <ul class="nav nav-pills side-menu side-menu-horizontal fw-bold" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="tab-groovy-{{ $project->id }}" data-bs-toggle="pill" data-bs-target="#groovy-code-{{ $project->id }}" type="button" role="tab"
                        aria-controls="groovy-code" aria-selected="true"><i class="fa-solid fa-file-code text-primary"></i>
                    Groovy
                </button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-kotlin-{{ $project->id }}" data-bs-toggle="pill" data-bs-target="#kotlin-code-{{ $project->id }}" type="button" role="tab"
        ...
        <div class="tab-content m-0" id="pills-tabContent">
            <div class="tab-pane fade show active" id="groovy-code-{{ $project->id }}" role="tabpanel" aria-labelledby="tab-groovy-code" tabindex="0">
                ...
                <div class="step">
                    ...
                    <p>Add the plugin dependency to your <code>build.gradle</code></p>
                </div>
    ...
    dependencies {
        classpath 'net.branchlock:obfuscation:2.1.2'
                ...
                <div class="step mt-4">
                    ...
                    <p>Apply the plugin in your <code>build.gradle</code></p>
                </div>
...
*/
apply plugin: net.branchlock.obfuscation.desktop.BLDPlugin
...
branchlock {
    ...
    projectId = '{{ $project->project_id }}' // The project ID of your Branchlock project
                ...
                <div class="step">
                    ...
                    <p>Run the "jar" task or  "shadowJar" to create an obfuscated Java archive</p>
                </div>
            </div>
            <div class="tab-pane fade" id="kotlin-code-{{ $project->id }}" role="tabpanel" aria-labelledby="tab-kotlin-code" tabindex="0">
                ...
                <div class="step">
                    <div class="circle">2</div>
                    <p>Add the plugin dependency to your <code>build.gradle.kts</code></p>
                </div>
    ...
    dependencies {
        classpath("net.branchlock:obfuscation:2.1.2")
                ...
                <div class="step mt-4">
                    <div class="circle">3</div>
                    <p>Apply the plugin in your <code>build.gradle.kts</code></p>
                </div>
